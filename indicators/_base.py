...
There are three layers involved in every indicator:
  ...
  3. The plugin registry (indicators/_registry.py)
...
class IndicatorAddMode(str, Enum):
    DIALOG = "dialog"
    CONTEXT = "context"
    TOOLBAR = "toolbar"
    HIDDEN = "hidden"
...
class IndicatorStoreHandler(Protocol):
...
class Indicator(ABC):
    ...
    def add_mode(self) -> IndicatorAddMode:
        return IndicatorAddMode.DIALOG
